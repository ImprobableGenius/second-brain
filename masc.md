...
- [ ] MASC-01 Missing calculator values | Estimate: 2h | Due: 2026-03-20
- [ ] MASC-02 EN feedback cleanup bundle | Estimate: 6h | Due: TBD
- [ ] MASC-03 Search regression handoff | Estimate: 5h | Due: TBD
- [ ] MASC-04 News and Updates regression + coin review | Estimate: 4h | Due: TBD
- Triage decision: with the EN feedback review, dynamic script evaluation, and archive-page coin update all closed, use Friday first for the promised 2h calculator missing-values fix, then route or schedule the remaining cleanup bundle and unresolved handoff items.
- Triage sequence:
