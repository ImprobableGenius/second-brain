...
4. For BANF-06, can the PO and content collection team confirm the DMC logo will be supplied as SVG for `MI_311`, and can they also acquire or create SVG sponsor logos for `MI_312` when Banff returns to the active lane?
5. For Banff next submission, can the PO and content collection team confirm which content will be used for `MI_324` and provide approved translated copy when Banff returns to the active lane?
...
24. For IPAM-06, does “complete staging site” mean deployment and smoke QA only, or does it also include a client-ready UAT pass and fix buffer?
